...
public class BlockLava extends Block16Fluid //implements ISaveable
   ...
   /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	private void setData(){
		...
		desiccantList.add(Block.waterMoving.blockID+2500*4096);
		desiccantList.add(Block.waterStill.blockID+2500*4096);
		
		for(int i=0;i<3;i++){
			desiccantList.add(BlockSolidLava.getInstance(i).blockID+2500*4096);//TODO add the rock types here
		}
