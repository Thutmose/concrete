...
public class BlockFullSolidREConcrete extends Block{


    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;
	
    public static BlockFullSolidREConcrete instance;
	
	public BlockFullSolidREConcrete(int par1) {
		super(par1, Material.rock);
		setCreativeTab(ConcreteCore.tabThut);
		setUnlocalizedName("fullREConcrete");
