...
public class Vector3 
{
	...
	//*/
	public boolean setBlock(World worldObj, int id, int meta)
	{
		return setBlock(worldObj, id, meta, 3);
	}
	public boolean setBlock(World worldObj, int id, int meta, int flag)
	{
	...
	public boolean setBlock(World worldObj,int id)
	{
