...
public class WorldChunkProviderFinite implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public WorldChunkProviderFinite(World par1World)
    {
        this.worldObj = par1World;
        this.mapFeaturesEnabled = true;
        this.rand = new Random(par1World.getSeed());
    ...
    public void generateTerrain(int par1, int par2, byte[] par3ArrayOfByte)
    {
        ...
        int idWater = BlockWater.instance.blockID;
            ...
            for (int l = 0; l < 16; ++l)
            {
                ...
                for (int k1 = 127; k1 >= 0; --k1)
                {
                    ...
                    else
                    {
                        ...
                        {
                        	par3ArrayOfByte[l1] = (byte)idStone;
                            if (j1 == -1)
                            {
                                if (i1 <= 0)
                                {
