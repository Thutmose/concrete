...
public class Items 
{
	...
	public static LiquidStack lava0Full = new LiquidStack(BlockLava.getInstance(0),1);
	public static LiquidStack lava1Full = new LiquidStack(BlockLava.getInstance(1),1);
	public static LiquidStack lava2Full = new LiquidStack(BlockLava.getInstance(2),1);
