...
public class BlockLiquidREConcrete extends Block16Fluid implements IRebar{
	...
	private void setData(){
		data = new Integer[][]{
				{BlockLiquidREConcrete.instance.blockID,BlockRebar.instance.blockID,BlockREConcrete.instance.blockID},
				{},
				{BlockLiquidREConcrete.instance.blockID,BlockRebar.instance.blockID,0,BlockREConcrete.instance.blockID},
				{BlockREConcrete.instance.blockID,0}
			};
